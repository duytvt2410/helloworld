...
public class LoginFB {
	...
	public static String FACEBOOK_APP_ID = "2017067068437279";
	public static String FACEBOOK_APP_SECRET = "cd18653c05dc31d2cd6ac0016da93b54";
	public static String FACEBOOK_REDIRECT_URL = "http://localhost:8080/loginfacebook";
	...
	public UserDetails buildUser(com.restfb.types.User user) {
		...
		UserDetails userDetail = new User(user.getName(), "", enabled, accountNonExpired, credentialsNonExpired, accountNonLocked, authorities);
